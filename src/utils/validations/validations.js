...
export const adminVehicleFormValidationSchema = Yup.object({
  model: Yup.string().required("Enter the vehicle model"),
  doors: Yup.number().required("Enter the number of doors"),
  seats: Yup.number().required("Enter the number of seats"),
  luggage: Yup.number().required("Enter the number of luggage"),
  transmission: Yup.string().required("Select a transmission type"),
  airConditioning: Yup.string().required(
    "Please select whether the vehicle has air conditioning or not"
  ),
  fuelType: Yup.string().required("Select a fuel type"),
  age: Yup.number().required("Enter the vehicle age"),
  pricePerHour: Yup.number().required("Enter the price per hour"),
